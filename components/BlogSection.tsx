...
export default function BlogSection() {
  const blog_posts = [
    {
      title: 'De Código Legacy a Moderno: Incrementando Conversión en 55%',
      excerpt: 'Caso real de modernización web con Django, React y Tailwind CSS. Proceso, desafíos y resultados',
    ...
    {
      title: 'Red Neuronal OCR: 97.83% de Precisión en Documentos',
      excerpt: 'Cómo construí un sistema de identificación de DNI/Pasaportes con TensorFlow y Keras superando soluciones comerciales',
    ...
    {
      title: 'Orquestación de Agentes IA: 45% Código Asistido',
      excerpt: 'Mi workflow como "Arquitecto y Piloto" usando Cursor, sub-agentes especializados y TDD para acelerar desarrollo',
